...
parser.add_argument("--img_root", type=str, default="datasets/aligned_fashion_dataset")
parser.add_argument("--inversion_root", type=str, default="datasets/w+_fashion_dataset/fashion/PTI")
